...
namespace TreinaWeb.LinqXML
{
    class Program
    {
        ...
        static void CriarXmlDOM()
        {
            ...
            contactsDocument.Save(@"D:\Treinamentos\TreinaWeb.LinqXML\Contatos1.xml");
            Console.WriteLine(@"Criando o arquivo XML com DOM em D:\Treinamentos\TreinaWeb.LinqXML\Contatos1.xml");
        }
        ...
        static void CriarXmlLinq()
        {
            ...
            contatos.Save(@"D:\Treinamentos\TreinaWeb.LinqXML\Contatos2.xml");
            Console.WriteLine(@"Criando o arquivo XML com LINQ to XML em D:\Treinamentos\TreinaWeb.LinqXML\Contatos2.xml");
        }

        static void ConsultaXML()
        {
            XDocument doc = XDocument.Load(@"D:\Treinamentos\TreinaWeb.LinqXML\Contatos2.xml");
        ...
        static void CriaContatos()
        {
            ...
            xmlContatos.Save(@"D:\Treinamentos\TreinaWeb.LinqXML\Contatos3.xml");
            Console.WriteLine(@"Criando o arquivo XML com DOM em D:\Treinamentos\TreinaWeb.LinqXML\Contatos3.xml");
        }
    }
}
